...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "5n3wc740r8ynkkkj7jmrez5mej2jxjps15r1j150gkzjm6yy8j5h",
  ...
  manifest = (
    ...
    metadata = (
      ...
      icons = (
        ...
        #appGrid = (svg = embed "app-graphics/appgrid-128x128.svg"),
        #grain = (svg = embed "app-graphics/grain-24x24.svg"),
        #market = (svg = embed "app-graphics/market-150x150.svg"),
        #marketBig = (svg = embed "app-graphics/market-big-300x300.svg"),
      ),

      website = "http://cachethq.io",
      # This should be the app's main website url.

      codeUrl = "https://github.com/CachetHQ/Cachet",
